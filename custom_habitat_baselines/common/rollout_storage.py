...
class RolloutStorage:
    ...
    def __init__(
        ...
        self.observations = {}
        self.OBS_LIST = OBS_LIST if OBS_LIST is not None else [] # ['panoramic_rgb', 'panoramic_depth', 'target_goal']
        ...
        #input(observation_space.spaces)
    ...
    def insert(
        ...
        # print('\033[0;33;40m[rollout] step {}\033[0m\n'.format(self.step))
